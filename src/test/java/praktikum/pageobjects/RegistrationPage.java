...
public class RegistrationPage {
    ...
    private final By passwordError = By.xpath(".//form[starts-with(@class, 'Auth_form')]//fieldset//div[@class='input__container']//p[starts-with(@class,'input__error')]");
    private final By title = By.xpath(".//main//h2");
    private final By registerButtonClick = By.xpath(".//a[starts-with(@class,'Auth_link')]");
    ...
    public void waitErrorIsVisible() {
        new WebDriverWait(webDriver, Duration.ofSeconds(10))
                .until(ExpectedConditions.visibilityOf(webDriver.findElement(passwordError)));
    }
    ...
    public void clickAuthLink() {
        waitButtonIsClickable();
        webDriver.findElement(registerButtonClick).click();
    }
